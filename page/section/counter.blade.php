                                    ...
                                    <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12">
                                        <div class="wrap-custom-file">
                                            <input type="file" name="counter_bg_img" id="counterBgImg"
                                                   accept=".gif, .jpg, .png"/>
                                            <label for="counterBgImg" id="counter_bg_img" @if($data->counter_bg_img)  class="file-ok"
                                                   style="background-image: url({{ asset($data->counter_bg_img) }})" @endif>
                                                <img class="upload-icon"
                                                     src="{{ asset('global/materials/upload.svg') }}" alt=""/>
                                                <span>{{ __('Update Image') }}</span>
                                            </label>
                                            @removeimg($data->counter_bg_img,counter_bg_img)
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
